...
object SparkYSB {
  def main(args: Array[String]): Unit = {
    ...
    val topology_name: String = YSBConstants.DEFAULT_TOPO_NAME
    ...
    val campaignLookup: HashMap[String, String] = new HashMap[String, String]
    ...
    val YSBSource = new YSBSource(ssc, source_par_deg, campaignAdSeq, runTimeSec, initialTime).generateDataSet()
  ...
  private def generateCampaignMapping(numCampaigns: Int): ListBuffer[CampaignAd] = {
    ...
    campaignArray.to[ListBuffer[CampaignAd]]
  }
