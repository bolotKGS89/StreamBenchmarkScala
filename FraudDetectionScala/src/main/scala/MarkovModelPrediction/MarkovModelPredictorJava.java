 ...
 * @author pranab
 */
public class MarkovModelPredictorJava extends ModelBasedPredictor implements Serializable  {
    private static final Logger LOG = LoggerFactory.getLogger(MarkovModelPredictorJava.class);
    ...
    public MarkovModelPredictorJava( ) {
